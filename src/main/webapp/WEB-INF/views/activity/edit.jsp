...
<div class="pd-20">
    <form id="activityForm" class="Huiform" action="${ctx}/activity/edit" method="post" >
        ...
        <table class="table table-border table-bordered table-bg table-sort public_click_content" id="header_top">
            <thead>
            <tr class="text-l">
                <th width="106"><span class="l f-16">基本信息</span><span class="l f-16"> | </span><span class="l f-16">活动报名</span>
                       <span class="r">
        ...
        <table class="table table-border table-bordered table-hover table-bg">
            ...
            <tr>
                ...
                <input type="hidden" id="activityLogo" value="${entity.activityLogo}"/>
...
<%--百度编辑器结束--%>
<script type="text/javascript" src="${ctx}/resources/js/activity/edit.js"></script>
