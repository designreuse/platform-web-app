...
<div class="formtable-cont formtable-query">
    <nav class="breadcrumb">
        ...
        <li>
            <a href="${ctx}/bill/client_list">委托方账单</a>
        </li>
    </nav>
    <h4 class="header">委托方账单</h4>
    <div class="bill">
        <form id="billListForm" action="${ctx}/bill/client_list"  class="form-inline">
            ...
            <div class="form-group">
                ...
                <c:if test="${billListView.aldBillVo.income==1}">
                    <input id="negative" type="checkbox" > 收入
                    <input id="positive" type="checkbox" checked> 支出
                </c:if>
                <c:if test="${billListView.aldBillVo.income==0}">
                    <input id="negative" type="checkbox" checked> 收入
                    <input id="positive" type="checkbox" > 支出
                </c:if>
		  ...
		  <div class="form-group">
            ...
            <%--<input name="pageIndex" value="${billListView.pageIndex}" hidden="hidden">
            <input name="pageSize" value="${billListView.pageSize}" hidden="hidden">
            <input name="rowCount" value="${billListView.rowCount}" hidden="hidden">--%>
        </form>
    </div>
</div>
        ...
        <table class="table table-hover f-size-12" style="border: 1px solid #dddddd; border-top: none;margin-bottom: 0">
            ...
            <tr>
                ...
                <td colspan="3" class="line_h46">
                    ...
                    <div class="server_chart dis_inb">
                        <a href="#"
            ...
            <c:forEach var="billDetailBo" items="${billDetailCountBo.billDetailBoList}">
                <tr>
                    ...
                    <%--<td>${billDetailBo.dealingsOrgName}</td>--%>
                    <td>
            ...
            <tr class="text_r">
                <td colspan="7">
                    <p>
                        <b>账单统计：</b>
                        <b class="mar_l20">收款共${billDetailCountBo.billStaticsBo.payCount}笔 <em class="font_color--warning mar_l10"> ¥<fmt:formatNumber value="${billDetailCountBo.billStaticsBo.payAmount}" pattern="#,##0.00"/></em></b>
                        <b class="mar_l20">付款共${billDetailCountBo.billStaticsBo.gatheringCount}笔 <em class="font_color--success mar_l10"> ¥<fmt:formatNumber value="${billDetailCountBo.billStaticsBo.gatheringAmount}" pattern="#,##0.00"/></em></b>
                    </p>
                    <p>
                        <span><b>进行中：</b><em class="mar_l10">未收${billDetailCountBo.billStaticsBo.noPayCount}笔</em><em class="mar_l10">¥<fmt:formatNumber value="${billDetailCountBo.billStaticsBo.noPayAmount}" pattern="#,##0.00"/></em><em class="mar_l10">未付${billDetailCountBo.billStaticsBo.noGatheringCount}笔</em><em class="mar_l10">¥<fmt:formatNumber value="${billDetailCountBo.billStaticsBo.noGatheringAmount}" pattern="#,##0.00"/></em>  </span>
                        <span class="mar_l20"><b>进行中：</b><em class="mar_l10">实收${billDetailCountBo.billStaticsBo.payEdCount}笔</em><em class="mar_l10">¥<fmt:formatNumber value="${billDetailCountBo.billStaticsBo.payEdAmount}" pattern="#,##0.00"/></em><em class="mar_l10">实付${billDetailCountBo.billStaticsBo.gatherEdCount}笔</em><em class="mar_l10">¥<fmt:formatNumber value="${billDetailCountBo.billStaticsBo.gatherEdAmount}" pattern="#,##0.00"/></em>  </span>
                    </p>
                </td>
            </tr>
            </tfoot>
...
<script type="text/javascript" src="${ctx}/resources/js/bill/client_list.js"></script>
<script>
