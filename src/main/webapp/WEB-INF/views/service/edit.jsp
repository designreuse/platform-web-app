...
<div id="message_position">
    ...
    <c:if test="${serviceOrderBo.status==1}"> <span class="r"><a href="#" id="srvOrder_stop" name="_self" class="btn btn-primary radius">取消</a> </span></c:if>
    <c:if test="${serviceOrderBo.status==2 || serviceOrderBo.status==3}"> <span class="r"><a href="#" id="srvOrder_stops" name="_self" class="btn btn-primary radius">终止</a> </span></c:if>
    </div>
</div>
...
<table class="table table-border table-bordered table-bg table-sort mt-15">
    ...
    <tr class="text-l">
        <th width="106" class="public_click_content"><span class="l f-16">贸易信息</span>
            ...
            <span class="r">
                <a id="correlation" href="javascript:void(0)" target="_self" class="btn btn-primary radius public_examine">
                    <i class="icon-plus"></i>关联贸易订单</a>
                <a href="javascript:void(0);" name="_self" class="btn btn-primary radius" id="addTradeOrders">
                    <i class="icon-plus"></i>新建贸易订单</a>
            </span>
            </c:if>
        </th>
    </tr>
        ...
        <div id ="addTradeOrder">
            <table class="table table-border table-bordered table-hover table-bg">
                <tbody id="createTradeOrderTb">
                    ...
                    <tr>
                        <th class="text-r"><span class="c-red">*</span>预计交货日期：</th>
                        <td><input class="Wdate" name="deliveryDate" type="text" id="deliveryDate" value="" onFocus="WdatePicker({isShowClear:false,readOnly:true,minDate:'$y-%M-%d'})"/></td>
                        <td class="text-r">最晚交货日期：</td>
                        <td><input class="Wdate" name="lastDate" type="text" id="lastDate" value="" onFocus="WdatePicker({isShowClear:false,readOnly:true,minDate:'$y-%M-%d'})"/></td>
                    </tr>
                    <tr>
                        <td class="text-r">附加说明：</td>
...
<%--<table class="table table-border table-bordered table-bg table-sort">--%>
    <%--<thead>--%>
    <%--<tr class="text-r">--%>
        <%--<th width="106"><p>应收：${feeList.planFee * feeList.actualRate}元 </p>--%>
            <%--<p>实收： ${feeList.actualFee * feeList.actualRate}</p></th>--%>
    <%--</tr>--%>
    <%--</thead>--%>
    <%--<tbody>--%>
    <%--</tbody>--%>
...
<div id="examine_box">
    <p><strong>关联贸易订单</strong><em class="examine_close">X</em></p>
    <font>订单号</font>
    <input id="linkTradeCode" width="240px" type="input" name="id" />
    <div style="clear:both;"></div>
    <span>
    	<input type="button" id="correlations" class="examine_close" value="提交">
