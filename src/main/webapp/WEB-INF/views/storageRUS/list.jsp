...
<ul class="breadcrumb">您当前位置：
    ...
    <li>
        <a href="${ctx}/logisticsAndStorage/storageRu/list">俄境仓储价格管理</a>
    </li></ul>
<%--table_block--%>
...
<div class="modal fade" id="addStorage" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form1" class="cmxform" action="${ctx}/logisticsAndStorage/storageRuSave" method="post">
...
<div class="modal fade" id="editStorage" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form2" class="cmxform" action="${ctx}/logisticsAndStorage/storageRuSave" method="post">
...
<script type="text/javascript" src="${ctx}/resources/js/store/storageRuList.js"></script>
