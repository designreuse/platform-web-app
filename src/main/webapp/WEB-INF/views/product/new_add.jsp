...
<nav class="breadcrumb">
    ...
    <li>
        <a href="${ctx}/producct/add">标准商品新增</a>
    </li>
</nav>
<div class="container-fluid">
    <form id="form1" class="formtable" action="${ctx}/product/save" method="post">
        <div class="formtable-cont">
                            ...
                            <div class="form-group">
                                <select class="form-control" id="catalogIdFirst" name="catalogIdFirst">
                                    ...
                                    <c:forEach items="${product.catalogBos}" var="catalogBo">
                                        <option value="${catalogBo.catalogId}" <c:if test="${catalogBo.catalogId == product.productBo.catalogIdFirst}">selected ="selected"</c:if>>${catalogBo.catalogNameCn}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="form-group">
                                <select class="form-control" id="catalogIdSecond" name="catalogIdSecond">
                                    ...
                                    <c:forEach items="${product.secondCatalogList}" var="catalogBo">
                                        <option value="${catalogBo.catalogId}" <c:if test="${catalogBo.catalogId == product.productBo.catalogIdSecond}">selected ="selected"</c:if>>${catalogBo.catalogNameCn}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="form-group">
                                <select class="form-control" id="catalogId" name="catalogId">
                                    ...
                                    <c:forEach items="${product.thirdCatalogList}" var="catalogBo">
                                        <option value="${catalogBo.catalogId}" <c:if test="${catalogBo.catalogId == product.productBo.catalogId}">selected ="selected"</c:if>>${catalogBo.catalogNameCn}</option>
                                    </c:forEach>
                                </select>
                        </div>
                    </div>
            ...
            <div class="formtable-list">
                <div class="col-xs-6">
                    ...
                    <div class="col-sm-7 col-md-8"><input class="form-control" type="text" name="hscode"><span></span></div>
                </div>
            </div>
            <div class="formtable-list">
                <div class="col-xs-6">
                    ...
                    <div class="col-sm-7 col-md-8">
                        <select class="form-control" name="unitId">
                            <c:forEach items="${product.unitTypes}" var="unit">
                                <option <c:if test="${unit.constValue == product.productBo.unitId}">selected ="selected"</c:if>  value="${unit.constValue}">${unit.constName}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-xs-6">
                    ...
                    <div class="col-sm-7 col-md-8">
                        <select class="form-control" name="standardUnitId">
                            <c:forEach items="${product.unitTypes}" var="unit">
                                <option <c:if test="${unit.constValue == product.productBo.standardUnitId}">selected ="selected"</c:if>  value="${unit.constValue}">${unit.constName}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
            ...
            <div class="formtable-list">
                <div class="col-xs-6">
                   ...
                   <%-- <div class="col-sm-7 col-md-8 label-cont hide-input">
                        <img src="${ctx}/resources/images/bn.jpg" width="300" height="100" name="productSrc" id="productSrc" onclick="reOLUploadFro();">
                        ...
                        <input class="hide" id="productLogo" id="logoUrl" name="logoUrl" value="${product.productBo.logoUrl}">
            ...
            <div class="border no-border-t">
                <c:forEach items="${product.propertyBos}" var="propertyBo">
                    <label class="checkbox-inline">
                        <input type="checkbox" name="propertyIdList" value="${propertyBo.propertyId}"> ${propertyBo.propertyNameCn}
                    </label>
                </c:forEach>
            </div>
        </div>
