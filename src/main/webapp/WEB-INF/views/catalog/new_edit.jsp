...
<nav class="breadcrumb">
    ...
    <li>
        <a href="${ctx}/catalog/${catalog.catalogBo.catalogId}/${catalog.catalogBo.level}/edit">商品品类编辑</a>
    </li>
</nav>
    ...
    <div class="formtable">
        <div class="formtable-nav">
            <ul class="list-inline">
                ...
                <li class="pull-right">
                    <c:if test="${!catalog.catalogBo.disabled}">
        ...
        <input type="hidden" id="disabled" value="${catalog.catalogBo.disabled}"/>
        <form id="form1" class="formtable-cont" action="${ctx}/catalog/save" method="post">
            <h4 class="header header-fl">基本信息</h4>
            <button type="submit" class="btn btn-primary header-button">保存</button>
            <div class="clear"></div>
            <div class="formtable-list">
                <div class="col-xs-6">
                    <label class="col-sm-5 col-md-4 formtable-list-require">品类编号：</label>
                    <div class="col-sm-7 col-md-8 label-cont">${catalog.catalogBo.catalogId}</div>
                    <input type="hidden"id="catalogId" name="catalogId" value="${catalog.catalogBo.catalogId}"/>
                </div>
            </div>
            <div class="formtable-list">
                <div class="col-xs-6">
                    ...
                    <div class="col-sm-7 col-md-8">
                        <input class="form-control" type="text" name="catalogNameCn" value="${catalog.catalogBo.catalogNameCn}">
                    </div>
                </div>
                <div class="col-xs-6">
                    <label class="col-sm-5 col-md-4 formtable-list-require">品类名称（俄文）：</label>
                    <div class="col-sm-7 col-md-8">
                        <input class="form-control" type="text" name="catalogNameRu" value="${catalog.catalogBo.catalogNameRu}">
                    </div>
                </div>
            </div>
            <div class="formtable-list">
                    ...
                    <div class="col-sm-7 col-md-8 pad_l30">
                        <c:forEach items="${catalog.levels}" var="level">
                            <label class="radio-inline">
                                <input type="radio" <c:if test="${level.constValue == catalog.catalogBo.level}">checked="checked" </c:if> name="level" value="${level.constValue}"> ${level.constName}
                            </label>
                        </c:forEach>
                    </div>
                </div>
                    ...
                    <div class="col-sm-7 col-md-8">
                        <div class="form-inline">
                            <div class="form-group">
                                <input type="hidden" id="first" value="${catalog.catalogBo.firstCatalogId}" />
                                <select class="form-control" id="secondLevel" name="firstCatalogId" >
                                    <option value="" >全部</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <input type="hidden" id="second" value="${catalog.catalogBo.secondCatalogId}" />
            ...
            <div class="formtable-list hide" id="indexShowDiv">
                <div class="col-xs-6">
                    ...
                    <div class="col-sm-7 col-md-8"><input class="form-control" placeholder="请填写数字" type="text" name="indexSort" value="${catalog.catalogBo.indexSort}"><span></span></div>
                </div>
                <div class="col-xs-6">
            ...
            <div class="formtable-list">
                <div class="col-xs-6">
                    ...
                    <div class="col-sm-7 col-md-8"><input class="form-control" placeholder="请填写数字" type="text" name="hscode" value="${catalog.catalogBo.hscode}"><span></span></div>
                </div>
                <div class="col-xs-6">
                    <label class="col-sm-5 col-md-4 formtable-list-require">商品图片：</label>
                    <%--  <input type="hidden" id="logo" value="${catalog.catalogBo.logo}"/>
                     <div class="col-sm-7 col-md-8 label-cont hide-input">
                        <img src="${ctx}/resources/images/bn.jpg" width="150" class="img-responsive" id="catalogSrc" onclick="reOLUploadFro();">
                        ...
                        <input class="hide" name="logo" value="${catalog.catalogBo.logo}">
                    ...
                    <div class="imgCropBox col-sm-7 col-md-8 label-cont hide-input" id="imgCropBox" >
                        <img src="<odpf:GetImgTag imgUrl='${catalog.catalogBo.logo}' width='200' height='200'></odpf:GetImgTag> " alt="" class="imgCropBtn img-responsive" id="imgCropBtn" >
                    </div>
                    <input class="hide" name="logo" type="text" id="catalogLogo" value="${catalog.catalogBo.logo}">
                </div>
            </div>
        </form>
...
<script type="text/javascript" src="${ctx}/resources/js/catalog/edit.js"></script>
