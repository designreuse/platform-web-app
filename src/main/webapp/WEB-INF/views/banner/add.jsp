...
<body>
<nav class="Hui-breadcrumb"><i class="icon-home"></i> 首页 <span class="c-gray en">&gt;</span> 广告管理 <span class="c-gray en">&gt;</span> 新建广告 </nav>
<div class="pd-20">
  <form id="bannerForm" method="post">
      <table class="table table-border table-bordered table-bg table-sort">
          ...
          <tr>
              ...
              <td><img src="${ctx}/resources/images/bn.jpg" width="300" height="100" id="bannerLogoSrc" onclick="reOLUploadFro();">
          ...
          <tr>
              ...
              <td>
                  <input id="url" type="text" class="easyui-validatebox" style="width:200px;height: 30px"  name="url">
          ...
          <tr>
              ...
              <td>
                  <input id="bannerDesc" type="text" class="easyui-validatebox" style="width:400px;height: 30px" name="bannerDesc">
