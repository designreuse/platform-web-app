...
<ul class="breadcrumb">您当前位置：
    ...
    <li>
        <a href="${ctx}/logisticsAndStorage/ratesRu/list">俄境运价列表</a>
    </li></ul>
<%--table_block--%>
        ...
        <div class="formtable-query mar_t20">
            <form class="form-inline">
                <div class="form-group">
                    <label>发货地：</label>
                    <input type="text" id="startAddr" value="满洲里" class="form-control">
                </div>
                <div class="form-group">
                    <label>目的地：</label>
...
<script type="text/javascript" src="${ctx}/resources/js/transport/ratesRuList.js"></script>
