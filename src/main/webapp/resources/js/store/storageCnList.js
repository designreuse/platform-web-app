$(function () {
    ...
    var easyUiTableParam = {
        url: window.ctx+'/logisticsAndStorage/storageCnList',
        columns: [{
            field:"id",
            title:'编号',
            align:'center',
...
$("#reset").click(function(){
    window.location.href=window.ctx + "/logisticsAndStorage/storageCn/list";
})
...
$(function(){
    ...
    var option1 = {
        ...
        validateDone:function(form){
            ...
            $.ajax({
                url:window.ctx+"/logisticsAndStorage/storageCnSave",
                dataType:"json",
                type:"post",
                data:$("#form1").serialize(),
                success:function(data){
                    location.href=window.ctx+"/logisticsAndStorage/storageCn/list"
                }
            })
        }
    }
