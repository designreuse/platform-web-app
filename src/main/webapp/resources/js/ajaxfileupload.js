...
jQuery.extend({
    ...
    uploadHttpData: function( r, type ) {
        ...
        responseText = responseText.substring(responseText.indexOf("{"),responseText.length);
        responseText = responseText.substring(0 , responseText.indexOf("<")==-1?responseText.length:responseText.indexOf("<"));
