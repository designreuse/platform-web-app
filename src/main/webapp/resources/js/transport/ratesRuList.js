$(function () {
    ...
    var easyUiTableParam = {
        url: window.ctx+'/logisticsAndStorage/ratesRuList',
        columns: [{
            field:"id",
            title:'运价编号',
            align:'center',
...
$("#reset").click(function(){
    window.location.href=window.ctx + "/logisticsAndStorage/ratesRu/list";
})
...
$(function(){
    ...
    var option1 = {
        ...
        validateDone:function(form){
            ...
            $.ajax({
                url:window.ctx + "/logisticsAndStorage/ratesRuSave",
                data:$(form).serialize(),
                type:"post",
                async:false,
