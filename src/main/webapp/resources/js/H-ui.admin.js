...
function Offline(obj,id){
	layer.confirm('确认要下架吗？',function(index){
		$(obj).parents("tr").find(".user-manage").prepend('<a style="text-decoration:none" onClick="Offline_a(this,\'10001\')" href="javascript:;" title="上架"><i class="icon-hand-up"></i></a>');
		$(obj).parents("tr").find(".user-status").html('<span class="label">下架</span>');
		$(obj).remove();
		layer.msg('下架!',1);
	});
}
/*商品-上架*/
function Offline_a(obj,id){
	layer.confirm('确认要上架吗？',function(index){
		$(obj).parents("tr").find(".user-manage").prepend('<a style="text-decoration:none" onClick="Offline(this,\'10001\')" href="javascript:;" title="下架"><i class="icon-hand-down"></i></a>');
		$(obj).parents("tr").find(".user-status").html('<span class="label label-success">已上架</span>');
		$(obj).remove();
		layer.msg('已上架!',1);
	});
}
...
$(function(){
	...
	$(".Hui-aside .menu_dropdown a").click(function(){
		...
		show_navLi.each(function() {
            ...
            //解决多tap第二次点击不出页面问题　edit by kimihua
	...
	function creatIframe(href,titleName){
		...
		var iframe_box=topWindow.find('#iframe_box');
        //删除<i></i> 即tap 关闭按钮　edit by kimihua
		show_nav.append('<li class="active"><span data-href="'+href+'">'+titleName+'</span><em></em></li>');
		tabNavallwidth();
		var iframeBox=iframe_box.find('.show_iframe')
		iframeBox.hide();
		iframe_box.append('<div class="show_iframe"><div class="loading"></div><iframe name="frame1" frameborder="0" src="'+href+'"></iframe></div>');
